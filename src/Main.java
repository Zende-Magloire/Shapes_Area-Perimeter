...
public class Main {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1: {
                    ...
                    double area = shapes[sChoice].area();
                    //      print out the area
    ...
    private static void fillShapes(Shape[] stuff, int count) {
        ...
        for (int i = 0; i < stuff.length; i++) {
            ...
            System.out.print("What kind of shape is it? (circle = 1, rectangle = 2)  ");
            //    read their response
            ...
            if (ans == 1){
                System.out.print("Enter x coordinate (positive):  ");
                double xC = Double.valueOf(Reader.nextLine());
                System.out.print("Enter y coordinate (positive):  ");
                double yC = Double.valueOf(Reader.nextLine());
                System.out.print("Enter the radius (positive):  ");
            ...
            //       ask and read in x, y, width and height values
                ...
                System.out.print("Enter the width (positive):  ");
                double wR = Double.valueOf(Reader.nextLine());
                System.out.print("Enter the length (positive):  ");
